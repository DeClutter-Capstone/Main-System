...
function ContactUs() {
  ...
  const inputBg   = isDark ? "#323232" : "#f9f9f9";
  ...
  const s: Record<string, CSSProperties> = {
    page: {
      ...
      backgroundColor: bg, transition: "background-color 0.3s ease",
    ...
    blobTR: {
      ...
      background: "radial-gradient(circle, rgba(71,144,253,0.18) 0%, transparent 70%)",
      pointerEvents: "none",
    },
    blobBL: {
      position: "absolute", bottom: "-40px", left: "-40px",
      width: "260px", height: "260px", borderRadius: "50%",
      background: "radial-gradient(circle, rgba(124,110,245,0.14) 0%, transparent 70%)",
      pointerEvents: "none",
    },
    heroInner: { position: "relative", maxWidth: "600px", margin: "0 auto" },
    badge: {
      display: "inline-block", padding: "4px 14px", borderRadius: "999px",
      background: "rgba(71,144,253,0.15)", color: "#4790fd",
    ...
    heroTitle: {
      ...
      color: isDark ? "#ffffff" : "#0d1b3e", margin: "0 0 16px",
    },
    heroSub: {
      fontSize: "1.05rem", lineHeight: 1.7, margin: 0,
      color: isDark ? "#c0c0c0" : "#4a5568",
    },
    main: { flex: 1, padding: "70px 24px", background: bg },
    grid: {
...
infoValue: { fontWeight: 700, color: text, fontSize: "0.95rem", marginBottom: "2px" },
    infoSub:   { fontSize: "0.82rem", color: muted },
    blurb: {
      background: isDark
    ...
    blurbText: { fontSize: "0.85rem", color: isDark ? "#c0c0c0" : "#4a5568", lineHeight: 1.7 },
    formCard: {
      background: surface, border: `1px solid ${border}`,
    ...
    successIcon: {
      ...
      background: "rgba(71,144,253,0.12)", display: "flex",
      alignItems: "center", justifyContent: "center",
      margin: "0 auto 20px", fontSize: "1.8rem",
    },
    successTitle: { fontSize: "1.4rem", fontWeight: 800, color: text, margin: "0 0 10px" },
    successText:  { fontSize: "0.95rem", color: muted, margin: "0 0 28px", lineHeight: 1.6 },
    resetBtn: {
      padding: "10px 28px", borderRadius: "999px",
      border: `1px solid ${border}`, background: "transparent",
      color: text, fontFamily: "'Alata', sans-serif",
      fontSize: "0.9rem", cursor: "pointer",
    },
    form: { display: "flex", flexDirection: "column", gap: "18px" },
    formHeading: { fontSize: "1.4rem", fontWeight: 800, color: text, margin: "0 0 6px" },
    formSub:     { fontSize: "0.85rem", color: muted, margin: 0 },
    ...
    input: {
      ...
      color: text, fontSize: "0.95rem", fontFamily: "'Alata', sans-serif",
    ...
    submitBtn: {
      ...
      boxShadow: "0 4px 16px rgba(71,144,253,0.3)",
      transition: "transform 0.2s ease, box-shadow 0.2s ease",
    },
  };

  const infoCards = [
    { color: "#4790fd", label: "Email",    value: "hello@declutter.app",   sub: "We reply within 24 hours" },
  ...
  return (
    <div style={s.page}>
      ...
      <style>{`
        .c-input:focus { border-color: #4790fd !important; box-shadow: 0 0 0 3px rgba(71,144,253,0.15) !important; }
        .c-input::placeholder { color: ${muted}; }
        .c-submit:hover { transform: translateY(-2px) !important; box-shadow: 0 8px 24px rgba(71,144,253,0.4) !important; }
